...
class Xhs extends Command
{
    ...
    public function __construct()
    {
        ...
        $cookies = CookieJar::fromArray([
            'hsTrackerId' => '84c3054f-e415-4b39-cb28-e1ce555fb698',
            'extra_exp_ids' => 'recommend_comment_hide_exp2,supervision_exp,supervision_v2_exp,commentshow_exp1,gif_clt1,ques_exp1',
            'timestamp2' => '20220419a4f93d2e45a5ec201ca43486',
            'timestamp2.sig' => 'c9kZdkKF6YrsXL3KKfWpzSE69lbQaWLNUvxW1a4qDGQ',
        ], '.xiaohongshu.com');
    ...
    {
        $this->http->get('');
            //        $response = $this->http->post('https://www.xiaohongshu.com/fe_api/burdock/v2/shield/registerCanvas?p=cc', [
//            'json' => [
